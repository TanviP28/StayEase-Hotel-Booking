    ...
    <View>
      ...
      >
        <View>
          ...
          <Text style={{ fontSize: 15 }}>
            {route.params.person}'s name Room is usually fully booked
          </Text>
        </View>
      ...
      <View style={{ padding: 10 }}>
        ...
        <View style={{ marginTop: 10 }}>
          <Text style={{ fontSize: 16, fontWeight: "bold" }}>Rooms</Text>
      ...
      >
        <Text style={{textAlign:"center",color:"white",fontSize:20,fontWeight:"bold"}}>Confirm</Text>
      </Pressable>
    </View>
    </ScrollView>
  );
